...
Used Gemini to check my answer on Q2, it agreed!
...
Gemini to try and understand what a `nullopt` is and an optional return type. Though I still am confused on it.
